# //AWS Configuration
variable access_key {"access key here"}
variable secret_key {"secret access key here"}
...
variable "privatecidraz1" {
  default = "192.168.106.0/25"
}

variable "hacidr" {
  default = "192.168.106.128/28"
}

variable "mgmtcidr" {
  default = "192.168.106.144/28"
}
